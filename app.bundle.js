...
function generateAndShowQuestions(e, operator) {
    ...
    var maxOperand1 = _ui.ui.getMaxOperand1();
...
var UI = function () {
    ...
    _createClass(UI, [{
        ...
        key: "getMaxOperand1",
        value: function getMaxOperand1() {
            return +this.maxOperand1.value;
        }
    }, {
        key: "getMaxOperand2",
        value: function getMaxOperand2() {
        ...
        value: function getAnswerElement(index) {
        ...
        value: function disableCheckAnswersButton() {
